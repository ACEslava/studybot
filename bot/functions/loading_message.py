...
def get_loading_message() -> str:
    ...
    messages = (
        ...
        (
            "The last time I tried this the monkey didn't survive. Let's hope it works"
            + " better this time."
        ),
        ...
        (
            "What is the difference btwn a hippo and a zippo?"
            + " One is really heavy, the other is a little lighter"
        ),
        (
            "Please wait, while we purge the Decepticons "
            + "for you. Yes, You can thanks us later!"
        ),
        (
            "Chuck Norris once urinated in a semi truck's gas "
            + "tank as a joke....that truck is now known as Optimus Prime."
        ),
        ...
        (
            "Composer hack: Waiting for reqs to be fetched"
            " is less frustrating if you add -vvv to your command."
        ),
